...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "AI Health Companion", path: "/chat", icon: Sparkles, badge: "AI" },
  { label: "Upload Prescription", path: "/upload-prescription", icon: Upload },
  { label: "Health Records", path: "/health-records", icon: FolderOpen },
  { label: "Find Healthcare", path: "/find-healthcare", icon: MapPin },
